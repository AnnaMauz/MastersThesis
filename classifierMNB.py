...
outputfile = "Results_classifierMNB.txt"
...
classifierMNB.fit(post_vectors, labels)
...
for testpost in testposts:
    ...
    predictionMNB = [classifierMNB.predict(test_vector)]
    resultMNB = predictionMNB[0] if predictionMNB[0] else "unclear"
    resultsMNB.append(resultMNB)
